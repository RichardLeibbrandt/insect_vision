function [critInput] = Relative_rectTargetPrep(Parameters, ScreenData, StimSettings, NumSubframes)
%
...
P.xposOffset  = Parameters(8,:);
P.yposOffset  = Parameters(9,:);
...
critInput.pos      = [(P.xpos + P.xposOffset) - P.width/2; (P.ypos + P.yposOffset) - P.height/2; ...
    (P.xpos + P.xposOffset) + P.width/2; (P.ypos + P.yposOffset) + P.height/2];
